...
---
## !ВНИМАНИЕ! Если вы выполняете задание на сервере (с использованием прокси) БАЗА ДАННЫХ У ВАС УЖЕ СОЗДАНА И ШАГ 2 СЛЕДУЕТ ПРОПУСТИТЬ
...
4. Укажите количество столбцов: `7`.
